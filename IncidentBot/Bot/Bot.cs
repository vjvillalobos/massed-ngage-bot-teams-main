...
namespace Sample.IncidentBot.Bot
{
    ...
    using Sample.IncidentBot.Models;
    ...
    public class Bot
    {
        ...
        private void CallsOnIncoming(ICallCollection sender, CollectionEventArgs<ICall> args)
        {
            ...
            var callType = callee?.Identity?.GetApplicationInstance() == null ? "BotIncoming" : "BotEndpointIncoming";

            this.AddCallToHandlers(call, callType);
